...
(function() {
  ...
  DebtGraph = (function() {
    ...
    DebtGraph.prototype.show = function(group) {
      ...
      return this['show_' + group]();
    };

    DebtGraph.prototype.show_all = function() {
      var _ref,
        _this = this;
      ...
      return this.force = d3.layout.force().gravity(0.08).charge(function(d) {
        return d.charge;
      }).nodes(this.lenders).size([this.size.width, this.size.height]).on('tick', function(e) {
    ...
    DebtGraph.prototype.show_status = function() {
    ...
    DebtGraph.prototype.show_college = function() {
      var groupFn, groups, names;

      groupFn = function(lender) {
        return lender.college;
      };
    ...
    DebtGraph.prototype.show_hometown = function() {
      var groupFn, groups, names;

      groupFn = function(lender) {
        return lender.hometown;
      };
    ...
    DebtGraph.prototype.show_greatness = function() {
      var groupFn, groups, names;

      groupFn = function(lender) {
        return lender.greatness;
      };
    ...
    DebtGraph.prototype.groupBy = function(groups, names, groupFn, maxCol) {
      ...
      this.lenders.forEach(function(lender) {
